        ...
        with open(_file, "r") as log:
            ...
            for line in rev_log:
                if (
                    ...
                    is not None
                    and re.search("(group grant|unit-to-unit grant)", line) is not None
                    and re.search(
                    ...
                    continue
                if re.search("(end of)", line) is not None:
                    continue
                ...
                if re.search("(voice rejection)", line) is not None:
                    alertClass = "warning"
                ...
                if (
                    ...
                    if re.search("(encrypted)", line) is not None:
                        typeClass = "success"
                        type = "Voice Transmission (Encrypt)"
                    else:
                        type = "Voice Transmission"
                if re.search("(data transmission|data header)", line) is not None:
                    type = "Data Transmission"
                if re.search("(group grant request)", line) is not None:
                    typeClass = "success"
                    type = "Group Grant Request"
                    if re.search("(denied)", line) is not None:
                        alertClass = "warning"
                        type = type + " (Denied)"
                    if re.search("(queued)", line) is not None:
                        alertClass = "info"
                        type = type + " (Queued)"
                if re.search("(unit-to-unit grant request)", line) is not None:
                    typeClass = "success"
                    ...
                    if re.search("(queued)", line) is not None:
                        alertClass = "info"
                        type = type + " (Queued)"
                if re.search("(group affiliation request)", line) is not None:
                    typeClass = "warning"
                    type = "Group Affiliation"
                    if re.search("(denied)", line) is not None:
                        alertClass = "warning"
                        type = type + " (Denied)"
                if re.search("(group affiliation query command)", line) is not None:
                    typeClass = "info"
                    type = "Group Affiliation Query"
                if re.search("(group affiliation query response)", line) is not None:
                    typeClass = "success"
                    type = "Group Affiliation Query"
                if re.search("(unit registration request)", line) is not None:
                    typeClass = "warning"
                    type = "Unit Registration"
                    if re.search("(denied)", line) is not None:
                        alertClass = "warning"
                        type = type + " (Denied)"
                if re.search("(unit registration command)", line) is not None:
                    typeClass = "info"
                    type = "Unit Registration Command"
                if re.search("(unit deregistration request)", line) is not None:
                    typeClass = "warning"
                    type = "Unit De-Registration"
                    if re.search("(denied)", line) is not None:
                        alertClass = "warning"
                        type = type + " (Not Registered)"
                if re.search("(location registration request)", line) is not None:
                    typeClass = "warning"
                    type = "Location Registration"
                    if re.search("(denied)", line) is not None:
                        alertClass = "warning"
                        type = type + " (Denied)"
                if re.search("(status update)", line) is not None:
                    typeClass = "info"
                    type = "Status Update"
                if re.search("(message update)", line) is not None:
                    typeClass = "info"
                    type = "Message Update"
                if re.search("(call alert)", line) is not None:
                    typeClass = "info"
                    type = "Call Alert"
                if re.search("(ack response)", line) is not None:
                    typeClass = "success"
                    type = "ACK Response"
                #            if (re.search('(cancel service)', line) is not None):
                #                typeClass = 'danger'
                #                type = 'Cancel Service'
                if re.search("(radio check request)", line) is not None:
                    typeClass = "info"
                    type = "Radio Check"
                if re.search("(radio check response)", line) is not None:
                    typeClass = "success"
                    type = "Radio Check ACK"
                if re.search("(radio inhibit request)", line) is not None:
                    typeClass = "danger"
                    type = "Radio Inhibit"
                if re.search("(radio inhibit response)", line) is not None:
                    typeClass = "danger"
                    type = "Radio Inhibit ACK"
                if re.search("(radio uninhibit request)", line) is not None:
                    typeClass = "danger"
                    type = "Radio Uninhibit"
                if re.search("(radio uninhibit response)", line) is not None:
                    typeClass = "success"
                ...
                if re.search("(denied)", _from) is not None:
                ...
                if re.search("(data transmission)", line) is not None:
                    _to = "N/A"
